...
const AvailableAddons = ({ handleOrignalStep, handleChange, formValues }) => {
  ...
  const availableAddons = t("stepTen.addons", { returnObjects: true });
  console.log("availableAddons:", availableAddons); // Log the availableAddons for debugging

  return (
    <div className="formContainer step-form">
      <h2 className="addon-section-title">{t("stepTen.addonSectionTitle")}</h2>

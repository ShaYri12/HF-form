    ...
    <div className="formContainer step-form">
      <div className="title-info">
        ...
        <span className="appointment-details">
          {t("appointmentConfirm.pending")}{" "}
          <strong>{values.stepTwo.title}</strong> {t("appointmentConfirm.at")}{" "}
          <b>{values.appointment?.selectedTime?.start}</b>{" "}
          {t("appointmentConfirm.on")} <b>{values.appointment.selectedDay}</b>{" "}
          {t("appointmentConfirm.withNutrition")}
          <b></b>
        </span>
      </div>
      ...
      <div className="btn-group btn-group-stepthree appoint-confirm-btns">
        <button
          type="button"

...
const StepSeven = ({
  ...
  const validateForm = () => {
    ...
    // Updated Regex pattern for alphanumeric and additional special characters
            ...
            <div className="btn-group btn-group-stepthree">
              <button
                ...
                className={`back-btn back-btn-stepthree ${
                  showQuestion1 === null ? "back-btn-grow" : ""
                }`}
                onClick={prevInfo}
              >
          ...
          <form onSubmit={handleSubmit} className="input-form">
            ...
            <div className="btn-group btn-group-stepthree">
              <button
                type="button"
                className={`back-btn back-btn-stepthree ${
                  showQuestion2 === null ? "back-btn-grow" : ""
                }`}
                onClick={prevInfo}
              >
                <img src="/assets/arrow.svg" alt="arrow" />{" "}
          ...
          <form onSubmit={handleSubmit} className="input-form">
            ...
            <div className="btn-group btn-group-stepthree">
              <button
                type="button"
                className={`back-btn back-btn-stepthree ${
                  showQuestion3 === null ? "back-btn-grow" : ""
                }`}
                onClick={prevInfo}
              >
                <img src="/assets/arrow.svg" alt="arrow" />{" "}
          ...
          <form onSubmit={handleSubmit} className="input-form">
            ...
            <div className="btn-group btn-group-stepthree">
              <button
                type="button"
                className={`back-btn back-btn-stepthree ${
                  showQuestion4 === null ? "back-btn-grow" : ""
                }`}
                onClick={prevInfo}
              >
                <img src="/assets/arrow.svg" alt="arrow" />{" "}
          ...
          <form onSubmit={handleSubmit} className="input-form">
            ...
            <div className="btn-group btn-group-stepthree">
              <button
                type="button"
                className={`back-btn back-btn-stepthree ${
                  showQuestion5 === null ? "back-btn-grow" : ""
                }`}
                onClick={prevInfo}
              >
                <img src="/assets/arrow.svg" alt="arrow" />{" "}
